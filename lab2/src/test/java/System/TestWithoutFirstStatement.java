...
public class TestWithoutFirstStatement {
    ...
    public TestWithoutFirstStatement(double input, double expected) {
        this.input = input;
    ...
    public void initTest () {
        ...
        when(firstStatement.calculate(0.0 - d)).thenReturn(Double.POSITIVE_INFINITY);
