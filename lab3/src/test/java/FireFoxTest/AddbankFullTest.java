       ...
       // driver.findElement(By.linkText("Профиль")).click();
        ...
        try {
            TestCase.assertEquals("1",
                    driver.findElement(By.xpath("html/body/section[2]/div[1]/aside/section[1]/div/div/div[2]/div[1]/div[1]/span")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        //driver.findElement(By.linkText("Показать"));
        //driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/section[2]/div[1]/aside/section[1]/div/div/div[2]/div[1]/div[1]/span")));
    }
